...
public class MetodosOrdenamiento {
    ...
    // Error encontrado: RETURN no debuelve nada
    //Solocion: modificar el return
    ...
    // Error encontrado:falta return en el arreglo
    //Solucion: Agregar retun
    ...
    // Método de selección con errores
    // Error encontrado:no se intrecanbian los indicesMenores
    //solucion; arreglos[i]-indicemenor
    ...
    // Error encontrado:blucle while falta =
    //solucion agregar =
    ...
    // Método de inserción con errores
    // Error encontrado: blucle incorrecto pero es posible hacer
    //completar el bucle for
    public int[] insercionSegundo(int[] arregloOriginal) {
        ...
        for (int j = 1; j < arreglo.length; j++) {
            ...
            // Mueve los elementos mayores que 'actual' una posición adelante
    ...
    // Método de inserción con errores
    // Error encontrado:retorna el arreglo original
